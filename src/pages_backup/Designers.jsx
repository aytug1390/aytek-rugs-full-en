        ...
        <div className="relative p-10 md:p-16">
          ...
          <div className="mt-6 inline-flex items-center gap-3 rounded-2xl bg-white/10 backdrop-blur px-4 py-3">
            ...
            <p className="text-base md:text-lg">
              <b>Free Visual Mockup:</b> Talep üzerine mekan fotoğrafınıza halıyı yerleştirip
              <b> ücretsiz</b> görsel çizim gönderiyoruz.
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {["proj1.webp","proj2.webp","proj3.webp","proj4.webp","proj5.webp","proj6.webp"].map((n) => (
            <img
              ...
              onError={(e) => { e.currentTarget.src = '/images/placeholder-step.svg'; }}
            />
          ))}
        </div>
      </section>
