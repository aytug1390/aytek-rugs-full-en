...
// Prefer explicit env; during local development default to the local API server on port 5001.
const API_BASE = process.env.API_BASE || process.env.ADMIN_API_ORIGIN || process.env.API_ORIGIN || "http://127.0.0.1:5001";
