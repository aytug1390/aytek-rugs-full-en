    ...
    <section className="relative w-full h-[600px] overflow-hidden" aria-label="Hero Slideshow">
      ...
      {slides.map((s, i) => (
        <img
          ...
          } ${i === 1 ? "object-[60%]" : "object-center"}`}
          loading={i === 0 ? "eager" : "lazy"}
          onError={(e) => {
            if (!e.currentTarget.dataset.fallback && e.currentTarget.src.includes("/hero-bg/")) {
              e.currentTarget.src = e.currentTarget.src.replace("/hero-bg/", "/bg/");
