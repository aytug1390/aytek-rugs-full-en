...
(async()=>{
  ...
  try{ const b = await fetchUrl('http://127.0.0.1:5000/admin-api/products?product_id=16390&limit=1'); console.log('backend',b.status); console.log(b.body.slice(0,2000)); }catch(e){ console.error('backend failed',e.message); }
})();
