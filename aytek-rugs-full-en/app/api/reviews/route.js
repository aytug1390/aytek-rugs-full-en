...
export async function GET() {
  ...
  return jsonUtf8(reviews, { status: 200, headers: { "Content-Type": "application/json; charset=utf-8", "X-Content-Type-Options": "nosniff" } });
  } catch (e) {
...
export async function POST(req) {
  ...
  return jsonUtf8(doc, { status: 201, headers: { "Content-Type": "application/json; charset=utf-8", "X-Content-Type-Options": "nosniff" } });
  } catch (e) {
    return jsonUtf8({ error: e.message }, { status: 500 });
  }
}
