...
export async function POST(req) {
  ...
  return jsonUtf8({ ok: true, created: true }, { status: 201, headers: { 'Content-Type': 'application/json; charset=utf-8', 'X-Content-Type-Options': 'nosniff' } });
  } else {
    ...
    await user.save();
  return jsonUtf8({ ok: true, updated: true }, { status: 200, headers: { 'Content-Type': 'application/json; charset=utf-8', 'X-Content-Type-Options': 'nosniff' } });
  }
}
