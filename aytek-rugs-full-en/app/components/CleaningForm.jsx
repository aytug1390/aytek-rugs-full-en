  ...
  return (
    <section id="cleaning-form" className="max-w-3xl mx-auto bg-white rounded-2xl shadow p-6 mt-12">
      ...
      <form onSubmit={onSubmit} className="space-y-4">
              ...
              <div key={idx} className="grid grid-cols-12 gap-2 items-end">
                ...
                <div className="col-span-3">
                  ...
                  <select
                    ...
                    aria-label={`Unit for size ${idx + 1}`}
                    name={`sizes[${idx}][unit]`}
                    className="w-full rounded-xl border px-3 py-2"
                    value={s.unit}
        ...
        <div>
          <label htmlFor="cleaning-notes" className="block text-sm font-medium mb-1">Notes (optional)</label>
          <textarea
            id="cleaning-notes"
            name="notes"
            className="w-full rounded-xl border px-3 py-2"
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <label htmlFor="cleaning-consent" className="text-sm">
