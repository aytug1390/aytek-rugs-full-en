        ...
        {slides.map((slide, index) => (
          ...
          >
            ...
            <img
              ...
              onError={(e) => {
                try {
                  // First try the bg -> hero fallback
                  const target = e.currentTarget;
                  if (!target.dataset.fallback) {
                    const s = target.src || "";
                    if (s.includes("/images/bg/")) {
                      target.src = s.replace('/images/bg/', '/images/hero/');
                    } else {
                      target.src = '/images/placeholders/hero-placeholder.svg';
                    }
                    target.dataset.fallback = '1';
                  }
                } catch (err) {
                  e.currentTarget.src = '/images/placeholders/hero-placeholder.svg';
                }
              }}
            />
