    ...
    <section id="designer-form" className="mt-14 bg-white rounded-2xl shadow p-6 md:p-8">
      ...
      <form onSubmit={onSubmit} className="mt-6 space-y-4">
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium" htmlFor="designer-projectType">Project Type</label>
            <select id="designer-projectType" className="w-full rounded-xl border px-3 py-2" value={form.projectType} onChange={(e)=>update("projectType", e.target.value)}>
